...
namespace lab2db
{
    public partial class Gamintojai : Form
    {
        ...
        public Boolean arYra(string pavad)
        {
            ...
            string query = string.Format("SELECT pavadinimas FROM gamintojas where pavadinimas='{0}'", pavad);
        ...
        private void Nuskaityt_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM gamintojas";
            MySqlConnection databaseConnection = new MySqlConnection(connectionString);
            MySqlCommand commandDatabase = new MySqlCommand(query, databaseConnection);
            commandDatabase.CommandTimeout = 60;
            MySqlDataReader reader;
        ...
        private void pridet_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = string.Format("INSERT INTO gamintojas Values('{0}','{1}')", textBox2.Text, textBox1.Text);
                MySqlConnection databaseConnection = new MySqlConnection(connectionString);
        ...
        {
            string query = string.Format("UPDATE gamintojas SET pavadinimas='{0}' Where id_gamintojas='{1}'", textBox2.Text, textBox1.Text);
        ...
        {
            string query = string.Format("UPDATE produktas SET fk_gamintojasid_gamintojas=NULL Where fk_gamintojasid_gamintojas='{0}';" + "DELETE from gamintojas Where id_gamintojas='{0}'", textBox1.Text);
