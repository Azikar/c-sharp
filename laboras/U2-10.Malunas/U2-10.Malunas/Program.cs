...
// reikiamas miltu kiekis:
           ...
           if(maz>rusis1.imtnuostolis())
            ...
            if (rusis1.imtnuostolis() == rusis2.imtnuostolis() && rusis1.imtnuostolis() == rusis3.imtnuostolis())
            ...
            Console.WriteLine("{0} grudu reikia {1} t", rusis1.imtrusi(), gr_kiek(pav,rusis1,1));
            Console.WriteLine("{0} grudu reikia {1} t", rusis2.imtrusi(), gr_kiek(pav, rusis2,2));
            Console.WriteLine("{0} grudu reikia {1} t", rusis3.imtrusi(), gr_kiek(pav, rusis3,3));
        ...
        static double gr_kiek(Malunas m,Grudai g, int kuriuMiltu)
        {
            if(kuriuMiltu==1)
                return (Math.Round(m.imtpirm() / (1 - g.imtnuostolis() / 100.00), 2));
            if(kuriuMiltu==2)
                return (Math.Round(m.imtantr() / (1 - g.imtnuostolis() / 100.00), 2));
            if (kuriuMiltu == 3)
                return (Math.Round(m.imttret() / (1 - g.imtnuostolis() / 100.00), 2));
